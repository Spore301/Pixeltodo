...
class AsciiFilter {
  ...
  constructor(renderer: THREE.WebGLRenderer, { fontSize, fontFamily, charset, invert }: AsciiFilterOptions = {}) {
    ...
    this.charset = charset ?? ' .,:;i1tfLCT?*#MW&8%B@$';
...
class CanvAscii {
  ...
  setMesh() {
    ...
    if (this.textCanvas.width <= 20 || this.textCanvas.height <= 20) {
      console.error('Canvas text not rendered properly - font may not be loaded');
      return;
    }
